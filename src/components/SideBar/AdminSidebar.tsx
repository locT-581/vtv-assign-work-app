...
export default function AdminSideBar() {
  ...
  return (
    <div className="sidebar w-[8vh] desktop:w-1/5">
      <div className="px-4 py-12 desktop:px-8 h-full flex flex-col justify-between cursor-pointer">
        <Link to="/">
          <div className="logo-placeholder">
            <img src={getIcon('logoVTV')} alt="logo" className="logosidebar" />
          </div>
        </Link>
        <div className="title text-vtv-blue hidden desktop:block cursor-pointer">
        ...
        <ul className="flex-row items-center">
          <li className="flex justify-center items-center desktop:justify-start cursor-pointer">
        ...
        <div className="mt-auto flex justify-center cursor-pointer">
